...
public class MineonModVariables {
	public MineonModVariables(MineonModElements elements) {
	...
	public void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
		if (event.getObject() instanceof PlayerEntity && !(event.getObject() instanceof FakePlayer))
			event.addCapability(new ResourceLocation("mineon", "player_variables"), new PlayerVariablesProvider());
	}
